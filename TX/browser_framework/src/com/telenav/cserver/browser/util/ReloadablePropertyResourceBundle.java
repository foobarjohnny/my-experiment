...
public class ReloadablePropertyResourceBundle extends PropertyResourceBundle {
	...
	public ReloadablePropertyResourceBundle(java.io.InputStream stream)
	...
	public ReloadablePropertyResourceBundle(java.io.InputStream stream,
			String fileName, long lastModified) throws java.io.IOException {
	...
	public static ResourceBundle getResourceBundle(String baseName,String locale[])
			throws MissingResourceException {
		
		return getResourceBundle(baseName, new Locale(locale[0],locale[1]));
