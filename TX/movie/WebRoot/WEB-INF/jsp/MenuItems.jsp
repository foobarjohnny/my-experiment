...
<% 
	//TODO replace to URL from property file
	String POI_host = "{poi.http}/goToJsp.do?jsp=SearchPoi";
%>
	...
	<tml:menuItem name="ChangeDate" onClick="OnDateChange" text="<%=msg.get("menu.change.date")%>" trigger="KEY_MENU">
	</tml:menuItem>
	
	<%--new search--%>
	<tml:menuItem name="NewSearch" onClick="newSearch" text="<%=msg.get("menu.new.search")%>"  trigger="KEY_MENU">
	</tml:menuItem>
