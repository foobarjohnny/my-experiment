...
//<!------- modify me 1---------
@PrepareForTest({ExecutorDispatcher.class,LookUpMovieAction.class,ActionMapping.class})
@SuppressStaticInitializationFor({"com.telenav.cserver.movie.html.action.LookUpMovieAction","com.telenav.cserver.framework.executor.ExecutorDispatcher"})
//<!-------
public class TestLookUpMovieAction extends TestCase{
	...
	//---- modify me 2----------
	private Class<LookUpMovieAction> actionClass = LookUpMovieAction.class;
	private LookUpMovieAction testedAction = Whitebox.newInstance(actionClass);
	private LookUpMovieAction testedAction4Ex = PowerMock.createPartialMock(actionClass,"addErrors");
