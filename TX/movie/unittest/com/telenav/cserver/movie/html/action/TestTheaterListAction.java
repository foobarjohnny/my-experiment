...
//<!------- modify me 1---------
@PrepareForTest({ExecutorDispatcher.class,TheaterListAction.class,ActionMapping.class})
@SuppressStaticInitializationFor({"com.telenav.cserver.movie.html.action.TheaterListAction","com.telenav.cserver.framework.executor.ExecutorDispatcher"})
//<!-------
public class TestTheaterListAction extends TestCase{
	...
	//---- modify me 2----------
	private Class<TheaterListAction> actionClass = TheaterListAction.class;
	private TheaterListAction testedAction = Whitebox.newInstance(actionClass);
	private TheaterListAction testedAction4Ex = PowerMock.createPartialMock(actionClass,"addErrors");
	
	//---- modify me 3, over----------
	private Class<TheaterListResponse> responseClass = TheaterListResponse.class;
	private TheaterListResponse executorResponse = PowerMock.createMock(responseClass);
	//----
