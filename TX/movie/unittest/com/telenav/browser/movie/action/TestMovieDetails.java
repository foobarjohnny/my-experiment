...
public class TestMovieDetails {
	...
	public void setUp() throws Exception {
		...
		EasyMock.expect(handler.getParameter("theaterId")).andReturn(null);
		EasyMock.expect(handler.getParameter("hasTickets")).andReturn(null);
		...
		mapping.addForwardConfig(new ActionForward("success","/jsp/MovieDetails.jsp",false));
	...
	public void testDoAction() {
		try {
			PowerMock.replayAll();
			movieDetails.doAction(mapping, httpRequest, httpResponse);
			PowerMock.verifyAll();
		} catch (Exception e) {
