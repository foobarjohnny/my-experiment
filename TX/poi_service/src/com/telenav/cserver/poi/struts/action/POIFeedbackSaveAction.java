...
public class POIFeedbackSaveAction extends PoiAjaxAction {
	private static Logger logger = Logger.getLogger(POIFeedbackSaveAction.class);
    ...
    public ActionForward doAction(ActionMapping mapping,
        ...
        try {
            ...
            POIFeedbackSaveResponse executorResponse = new POIFeedbackSaveResponse();
