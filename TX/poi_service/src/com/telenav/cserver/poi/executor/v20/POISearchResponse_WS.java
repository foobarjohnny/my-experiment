...
public class POISearchResponse_WS extends ExecutorResponse
{
	...
	/*
	public List<BasePoi> getBaseSponsorPoiList() {
		return baseSponsorPoiList;
	}

	public void setBaseSponsorPoiList(List<BasePoi> baseSponsorPoiList) {
		this.baseSponsorPoiList = baseSponsorPoiList;
	}
	*/
}
