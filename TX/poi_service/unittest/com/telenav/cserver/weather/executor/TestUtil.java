...
{
	public static final String poiCServerUrl = "http://hqd-tn70-02.telenav.com:8080/poi_service/telenav-server-pb";
...
//			stop.city = "SANTA CLARA";
	...
	public static ExecutorContext getExecutorContext() {
		...
		tnContext.addProperty("login", "4085057537");
		tnContext.addProperty("userid", "9826225");
		tnContext.addProperty( TnContext.PROP_MAP_DATASET , "NT" );
	...
	public static ExecutorContext getExecutorContext64() {
		ExecutorContext context = new ExecutorContext();
		TnContext tnContext = new TnContext();
		tnContext.addProperty(TnContext.PROP_CARRIER, "MMI");
		tnContext.addProperty(TnContext.PROP_DEVICE, "8900");
		tnContext.addProperty(TnContext.PROP_PRODUCT, "RIM");
		...
		tnContext.addProperty("login", "4085057537");
		tnContext.addProperty("userid", "9826225");
		tnContext.addProperty( TnContext.PROP_MAP_DATASET , "MMI" );
		context.setTnContext(tnContext);
		return context;
	}

	public static UserProfile getUserProfile64() {
		UserProfile userProfile = new UserProfile();
		userProfile.setMin("4085057537");
		userProfile.setPassword("7537");
