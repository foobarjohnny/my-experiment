...
public class PoiReviewActionTest {

	private int	ajaxChildValue = 110;
	private String actionName = "reviewPoi.do";
	private String failString = "couldn't find the TxNode in file when testing reviewPoi action";
	
	private ActionMapping mapping = new ActionMapping();
	private MockHttpServletRequest request = null;
	private MockHttpServletResponse response = new MockHttpServletResponse();
	
	public 	PoiReviewAction poiReviewAction = new PoiReviewAction();
	...
	public void testDoActionAction() {
		try 
		{
			...
			poiReviewAction.doAction(mapping, request, response);
