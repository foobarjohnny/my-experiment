...
public class TestValidateAddressAction extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		node.addMsg("{\"lastLine\":\"New Delhi, Delhi, India\",\"firstLine\":\"\",\"country\":\"IN\"}");
	...
	public void testValidateAddressAction() throws Exception {
		ValidateAddressAction action = new ValidateAddressAction();
		action.setRequestParser(new ValidateAddressRequestParserACEWS());
		action.setResponseFormatter(new ValidateAddressResponseFormatterACEWS());
