...
public class CommonValidateAddressHandlerTest {


	private CommonValidateAddressHandler instance = new CommonValidateAddressHandler();
	private DataSource dataSource = new DataSource();

	@Before
	public void setUp() throws Exception {
		
		dataSource.addData(String.class.getName(), String.valueOf(ExecutorResponse.STATUS_OK));
