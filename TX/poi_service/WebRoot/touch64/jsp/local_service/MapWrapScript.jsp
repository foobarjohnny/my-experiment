...
<%}%>		
		...
		func convertStopToFeature(JSONObject stop)
			...
			String county = JSONObject.get(stop,"county")
			String locality = JSONObject.get(stop,"locality")
	...
	<tml:menuItem name="oneBoxSearchMenu" pageURL="<%=getPage + "GoToOneBoxSearch#Common"%>">
	</tml:menuItem>
