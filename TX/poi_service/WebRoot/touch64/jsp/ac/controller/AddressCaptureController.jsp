...
<tml:script language="fscript" version="1">
		<![CDATA[
			...
			func AddressCapture_C_saveBackAction(String backAction)
	           AddressCapture_M_saveBackAction(backAction)
	        endfunc
	        
	        func AddressCapture_C_getBackAction()
	           return AddressCapture_M_getBackAction()
	        endfunc
	        
	        func AddressCapture_C_deleteBackAction()
