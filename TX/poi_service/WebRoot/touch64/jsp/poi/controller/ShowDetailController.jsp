		...
		<![CDATA[
			...
			func ShowDetail_C_saveForDetail(JSONArray addressList, int nomalIndex,JSONArray sponsorList,int sponsorIndex)
			    ...
			    if nomalIndex > -1
		           ...
		           int sponIndex = (nomalIndex/9)*sponsorListNumber + 1
			       ...
			       if 1 == sponsorListNumber
			          totalIndexForDetail = sponsorIndex * <%=Constant.PAGE_SIZE + 1%>
			       else
			          totalIndexForDetail = ((sponsorIndex+1)/sponsorListNumber) * (<%=Constant.PAGE_SIZE%>+sponsorListNumber) - sponsorIndex%sponsorListNumber
			       endif
			    endif
