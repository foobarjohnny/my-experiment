...
<tml:TML outputMode="TxNode">
	...
	<tml:menuItem name="doSubmitMenu" text="<%=msg.get("common.button.Submit")%>" trigger="KEY_MENU" onClick="doSubmit">
	</tml:menuItem>
	...
	<tml:page id="RatePoi" url="<%=getPage + "RatePoi"%>" groupId="<%=GROUP_ID_POI%>"
		...
		<tml:menuItem name="ratePoiBytouch64" trigger="TRACKBALL_CLICK" onClick="ratePoiBytouch64"/>
		<tml:listBox id="list">
			<tml:compositeListItem id="composite" 
				isFocusable="true" getFocus="false" visible="true" bgColor="#FFFFFF"
				transparent="false">
				
				<tml:label id="selectRatings" fontWeight="system_large" textWrap="wrap"
					align="center" focusFontColor="black" fontColor="black" >
					<%=msg.get("poi.select.ratings")%>
				</tml:label>

				
				<tml:menuRef name="ratePoiBytouch64"/>
