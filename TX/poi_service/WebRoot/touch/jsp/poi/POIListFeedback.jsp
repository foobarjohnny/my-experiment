		...
		<![CDATA[
			...
			func getFeedbackLabel()
				...
				if(searchKeyword != NULL && searchKeyword != "")
					feedbackLabel = System.parseI18n("<%= msg.get("poi.feedback.listQuestionWithKeyword")%>") + " " + searchKeyword + "?";
			...
			func getFeedBackValue()
                ...
                JSONObject searchLocation = PoiList_M_getAddress()
           		String searchLocationStr = JSONObject.toString(searchLocation)
