...
<%@ include file="/touch62/jsp/ac/controller/AddressCaptureController.jsp"%>
	...
	<%@ include file="/touch62/jsp/local_service/model/MapWrapModel.jsp"%>
	<jsp:include
		page="/touch62/jsp/local_service/controller/DriveToWrapController.jsp" />
			<%@ include
		file="/touch62/jsp/controller/ATTExtrasController.jsp"%>
		<%@ include file="/touch62/jsp/ac/controller/ShareAddressController.jsp"%>
	...
	<%@ include
		file="/touch62/jsp/ac/controller/ShareAddressController.jsp"%>
	<%@ include file="/touch62/jsp/poi/controller/SearchPoiController.jsp"%>
	<%@ include file="/touch62/jsp/poi/controller/ShowDetailController.jsp"%>
	<%@ include file="/touch62/jsp/poi/controller/PoiListController.jsp"%>
	<%@ include file="/touch62/jsp/ac/controller/RecordLocationController.jsp"%>
	...
	<%@ include file="/touch62/jsp/model/StartUpModel.jsp"%>
