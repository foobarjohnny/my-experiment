...
<tml:TML outputMode="TxNode">
	...
	<%@ include file="/touch62/jsp/poi/controller/PoiSubCategoryController.jsp"%>
	...
	<tml:page id="mainPagePoiPage" url="<%=getPage + "SearchPoi"%>" groupId="<%=GROUP_ID_POI%>" scriptCallback="pageCallBack"
		...
		<% if(TnUtil.isATTRIM623(handlerGloble)||TnUtil.isSprint62(handlerGloble)||TnUtil.isRogersCarrier(strCarrier) || TnUtil.isUSCCRIM62(handlerGloble)||TnUtil.isVNRIM62(handlerGloble)|| TnUtil.isTMORIM62(handlerGloble) || TnUtil.isBoostAndroid62(handlerGloble) || TnUtil.isBoostRIM62(handlerGloble)){ %>
