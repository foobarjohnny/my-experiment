...
<%@ include file="../Header.jsp"%>
	...
	<%@ include file="/touch62/jsp/dsr/SpeakNumber.jsp"%>
...
<tml:script language="fscript" version="1">
		...
		<%@ include file="../GetServerDriven.jsp"%>
		    ...
		    <%}%>
				...
				<%if( TnUtil.isVMCANDROID62(handlerGloble) || TnUtil.isBellANDROID62(handlerGloble) || TnUtil.isRogersANDROID62(handlerGloble) || TnUtil.isATTANDROID62(handlerGloble)||TnUtil.isATTRIM623(handlerGloble)||TnUtil.isSprint62(handlerGloble)||TnUtil.isUsccAndroid62(handlerGloble)||TnUtil.isUSCCRIM62(handlerGloble)||TnUtil.isTMOAndroidUser(handlerGloble) || TnUtil.isBoostAndroid62(handlerGloble)||TnUtil.isVNRIM62(handlerGloble)||TnUtil.isTMORIM62(handlerGloble)){ %>
				...
				func onBack()
                   ...
                   if "" != backAction
                      ...
                      if "<%=Constant.BACK_ACTION_MAIN_SCREEN%>" == backAction
		                 ...
		                 return FAIL
		              elseif "OneBoxSearch" == backAction
