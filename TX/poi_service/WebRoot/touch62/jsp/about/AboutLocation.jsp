...
<tml:TML outputMode="TxNode">
	<tml:page id="AboutLocation" url="<%=getPage + "AboutLocation"%>" type="<%=pageType%>" helpMsg="$//$about" groupId="<%=GROUP_ID_MISC%>">
		...
		<tml:panel id="panel" layout="vertical">
			<tml:multiline id="textLabel" fontWeight="system"
				align="left|middle" heightAutoScale="true" isFocusable="true">
