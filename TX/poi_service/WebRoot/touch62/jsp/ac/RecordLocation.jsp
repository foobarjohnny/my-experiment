...
<%@include file="/touch62/jsp/ac/model/RecordLocationModel.jsp"%>
...
<%@ include file="/touch62/jsp/StopUtil.jsp"%>	
	...
	<tml:page id="RecordLocation" url="<%=getPage + "RecordLocation"%>" type="<%=pageType%>"  background="" groupId="<%=GROUP_ID_MISC%>">
		...
		<tml:label id="text1" fontWeight="system_median" align="center"/>
