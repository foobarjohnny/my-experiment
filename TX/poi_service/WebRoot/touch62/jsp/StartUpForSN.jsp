...
<tml:TML outputMode="TxNode">
	...
	<%if(TnUtil.isBAWUser(handlerGloble)){%>
		<tml:menuItem name="Purchase" pageURL="<%=purchasePageUrl+"ForBAW"%>"/>
	<%}else{%>
	...
	<tml:menuItem name="upgradeToPremiumBadge" onClick="onClickUpgradeToPremiumBadge" trigger="TRACKBALL_CLICK" />
	...
	<tml:page id="StartUp" url="<%=pageURL%>" type="<%=pageType%>" genericMenu="16"
		...
		<% if(TnUtil.isSprint62(handlerGloble) || TnUtil.isVNRIM62(handlerGloble) || TnUtil.isBoost62(handlerGloble)){ %>
		...
		<!--tml:listBox id="menuListBox" name="pageListBox:settingsList"
			...
			<%if(TnUtil.isSprint62(handlerGloble) || TnUtil.isVNRIM62(handlerGloble) || TnUtil.isTMOAndroid62(handlerGloble) || TnUtil.isBoostRIM62(handlerGloble)){ %>
		...
		imageClick="">
				<tml:menuRef name="upgradeToPremiumBadge"/>
				<tml:menuRef name="upgradeToPremiumMenu" />
				<tml:menuRef name="upgrade" />
				<tml:menuRef name="about" />
				<tml:menuRef name="referFriend" />
