...
<tml:TML outputMode="TxNode">
	...
	<tml:script language="fscript" version="1">
		<![CDATA[
		    ...
		    func checkAddress(String source)
		       ...
		       # Email must contain "@"
               int index = String.find(email, 0, "@")
               if index < 0
                  return 3
               endif
               # Email must contain "." after "@"
               index = String.find(email, index, ".")
               if index < 0
                  return 3
               endif
               
				#dot can not be the last char
		       if(index==String.getLength(email)-1)
		       	  return 3
		       endif
		       return 2
		    endfunc
	...
	<tml:page id="NameAndEmailPage" url="<%=getPageWithLocale + "NameAndEmail"%>" genericMenu="63"
