...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="SpeakFlow" url="<%=getDsrPage + "SpeakFlow3"%>" background="<%=backgroundUrl%>" type="<%=pageType%>" 
		...
		<%
			...
			{
				String imgeUrl = imageUrl + "number_" + (i+1) + ".png";
		%>
			<tml:menuItem name="<%="goToDetailMenu" + i%>" onClick="onClickDetail">
				<tml:bean name="indexClicked" valueType="int" value="<%=i + ""%>"></tml:bean>
			</tml:menuItem>	
			
			<tml:listItem id="<%="item" + i%>" blurIconImage="<%=imgeUrl%>" focusIconImage="<%=imgeUrl%>"
				align="left|middle" showArrow="true" isFocusable="true" fontWeight="bold|system_large">
