...
<%@ include file="/WEB-INF/jsp/local_service/GetGps.jsp"%>
	...
	<tml:page id="SpeakGettingPOI" url="<%=pageURL%>" type="<%=pageType%>" background="<%=imageUrl + "backgroud_no_title.png"%>" supportback="false" groupId="<%=GROUP_ID_DSR%>">	
		<tml:label id="text1" fontWeight="bold" align="center"/>
