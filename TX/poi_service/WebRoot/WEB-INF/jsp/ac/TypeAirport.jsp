...
<tml:TML outputMode="TxNode">
	...
	<tml:script language="fscript" version="1">
		<![CDATA[
		    ...
		    func displayButtonImage()
		    	...
		    	string imageUrl = "<%=imageUrl%>" + "speakInAirport_" + locale + ".png"
		    ...
		    endfunc
		      ...
		      func fillBox()
		          ...
		          Page.setControlProperty("doneButton","focused","true")
		      endfunc
	...
	<tml:menuItem name="validateAirport" onClick="validateAddressOnClick" />
	...
	<tml:page id="typeAirportPage" url="<%=pageUrl%>" type="<%=pageType%>" groupId="<%=GROUP_ID_AC%>"
		showLeftArrow="true" showRightArrow="true" helpMsg="$//$drivetoairport">
		...
		<tml:inputBox id="airportName" prompt="<%=msg.get("ac.airport.letter")%>" style="capital"
			fontWeight="system_large" type="dropdownfilterfield">
		...
		<tml:block feature="<%=FeatureConstant.DSR%>">
			<tml:image id="speakInButton" url="<%=imageUrl + "speakInAirport_en_US.png"%>" />
		</tml:block>
	</tml:page>
