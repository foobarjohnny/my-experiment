 ...
 * @date 2010-8-9
 */
public class TestAddressSharingServicev20 extends TestCase
{
    ...
    {
    	AddressSharingRequestV20 request = new AddressSharingRequestV20();
        ...
        AddressSharingResponse response = AddressSharingServiceProxyV20.getInstance().shareAddress(request, tnContext);
    ...
    public void testFeachAddress() throws ThrottlingException
    {
    	...
    	FetchSharedAddressResponse response = AddressSharingServiceProxyV20.getInstance().fetchSharedAddress(request, tnContext);
    ...
    public void testShareMovie() throws ThrottlingException
    {
        ...
        AddressSharingResponse response = AddressSharingServiceProxyV20.getInstance().shareMovie(request, tnContext);
        String statusCode = response.getStatusCode();
