...
import com.telenav.services.recentstop.v30.RecentstopServiceStub;
...
public class RecentStopsServiceProxy
{
    ...
    public final static String clientName = "c-server";// recentstop

    public final static String clientVersion = "1.0";// 2.0

    public final static String transactionId = "";//
    
    public final static String WS_RECENTSTOP = "RECENTSTOP_v20";
    ...
    public ConfirmResponse confirmReceived(ConfirmRequest cRequest, TnContext tc) throws ThrottlingException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                BasicResponseDTO response = stub.confirmReceived(request);
    ...
    {
        CliTransaction cli = new CliTransaction(CliConstants.TYPE_MODULE);
        cli.setFunctionName("Delete_Stops");
        ...
        try
        {
            ...
            try
            {
                ...
                BasicResponseDTO response = stub.delete(req);
    ...
    public QueryResponse getRecentStops(QueryRequest request, TnContext tc) throws ThrottlingException
    {
        ...
        if (request != null && logger.isDebugEnabled())
        {// log query request
            logger.debug("getRecentStops Request======>" + request.toString());
        }
        ...
        try
        {
            ...
            try
            {
                ...
                if (logger.isDebugEnabled())
                {// log query response
                    logger.debug("getRecentStops Reponse=====>" + response.toString());
                }
            }
            catch (Exception ex)
            {
