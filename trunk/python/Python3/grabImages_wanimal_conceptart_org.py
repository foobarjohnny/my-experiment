...
version 0.2
"""
import urllib.request, urllib.parse, urllib.error, http.client, urllib.parse
import re
import random
import os
import logging  
...
def httpExists(url):
    ...
    try:
        ...
        if resp.status == 200:  # normal 'found' status
            ...
            found = httpExists(urllib.parse.urljoin(url, resp.getheader('location', '')))
...
def gDownload2(url, savePath):
    ...
    try:
        ...
        disposition = urllib.parse.unquote(urllib.parse.unquote(fp.info().getheader('Content-disposition')))
...
#                print "author ", author
                ...
                save = str('c:/WANIMAL_conceptart.org/' + folderName + '/')
