...
public class MessagesTest
{
    ...
    public void getByEnum()
    {
        ...
        Assert.assertEquals("account_not_found", msgs.getBy(LoginEnum.ACCOUNT_NOT_FOUND));
    }
    ...
    public void getByEnumWithPrefix()
    {
        ...
        Assert.assertEquals("account_not_found", msgs.getByEnumWithPrefix(LoginEnum.ACCOUNT_NOT_FOUND,"login"));
    }
    ...
    public void getBatchStringWithPrefix()
    {
        ...
        Assert.assertEquals(2, msgs.getBatchStringWithPrefix("login").keySet().size());
    }
    ...
    public void removeSuffixedNumFrom()
    {
        ...
        Assert.assertEquals("login.account_not_found", msgs.removeSuffixedNumFrom("login.account_not_found.1"));
        Assert.assertEquals("", msgs.removeSuffixedNumFrom("login.account_not_found."));
        Assert.assertEquals("", msgs.removeSuffixedNumFrom("login.account_not_found"));
    }
    ...
    public void getBatchStringWithPrefixAndKeyIsTheSame()
    {
        ...
        Map returnMap=msgs.getBatchStringWithPrefix("login.account_not_found");
        List list=(List)returnMap.get("option");
        
        Assert.assertTrue(list instanceof List);
        Assert.assertTrue(2==list.size());
        
        //test overrite version, if the prefix of listkey and prefix of non-listkey is the same, then list will come first
