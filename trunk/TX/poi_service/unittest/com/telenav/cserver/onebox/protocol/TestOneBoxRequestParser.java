...
public class TestOneBoxRequestParser extends TestRequestParser{
	public void testParseBrowserRequest() {
		...
		OneBoxRequestParser requestParser = new OneBoxRequestParser();
		PowerMock.replayAll();
		try {
	...
	private TxNode getBodyTxNode(){
		...
		try {
			...
			jo.put("addressStringDest", TestUtil.getLocationJSON().toString());
