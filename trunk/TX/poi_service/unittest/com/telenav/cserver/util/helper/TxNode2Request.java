...
public class TxNode2Request {
	...
	public void toMockHttpServletRequest(MockHttpServletRequest request){
		...
		request.addParameter(DataHandler.KEY_CLIENT_SUPPORT_SCREEN_WIDTH, userProfile.getScreenWidth());
		request.addParameter(DataHandler.KEY_CLIENT_SUPPORT_SCREEN_HEIGHT, userProfile.getScreenHeight());
