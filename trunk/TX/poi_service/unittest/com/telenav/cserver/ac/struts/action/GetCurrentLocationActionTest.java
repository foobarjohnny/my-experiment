...
public class GetCurrentLocationActionTest {

	private int	ajaxChildValue = 110;
	private String actionName = "getCurrentLocation.do";
	private String failString = "couldn't find the TxNode in file when testing getCurrentLocation action";
	
	private ActionMapping mapping = new ActionMapping();
	private MockHttpServletRequest request = null;
	private MockHttpServletResponse response = new MockHttpServletResponse();
	
	public 	GetCurrentLocationAction getCurrentLocation = new GetCurrentLocationAction();
	...
	public void testDoActionAction() {
		try 
		{
			...
			getCurrentLocation.doAction(mapping, request, response);
