 ...
 */
public class HtmlTableAvailableAction extends HtmlPoiBaseAction {
	private static final Logger logger = Logger.getLogger(HtmlTableAvailableAction.class);
	...
	protected ActionForward doAction(ActionMapping mapping,
		...
		try {
			...
			GetTableDetailResponse response = new GetTableDetailResponse();
		...
		{
			e.printStackTrace();
			logger.error("HtmlTableAvailableAction#doAction",e);
