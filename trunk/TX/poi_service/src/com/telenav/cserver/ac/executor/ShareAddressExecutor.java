...
public class ShareAddressExecutor extends AbstractExecutor {
     ...
     */
	private Logger logger = Logger.getLogger(ShareAddressExecutor.class);
    ...
    public void doExecute(ExecutorRequest req, ExecutorResponse resp,
        ...
        addressSharingRequest.setPoi(request.getPoi());
        try {
	        AddressSharingResponse addressSharingResponse = AddressSharingServiceProxy.getInstance().shareAddress(addressSharingRequest, tnContext);
