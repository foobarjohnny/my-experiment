...
<tml:TML outputMode="TxNode" showUrl="<%=getPage + "ThirdPartAction"%>">
	...
	<jsp:include page="/WEB-INF/jsp/common/login/controller/LoginStartupController.jsp" />
	...
	<%@ include file="../controller/DriveToController.jsp"%>
	...
	<jsp:include
		page="/WEB-INF/jsp/ac/controller/EditRouteController.jsp"></jsp:include>
									...
									if 0 < addressSize
										if addressSize == 1
											...
											if jo!= NULL
												...
												if (1 == isStreetChanged || 1 == isCityChanged) && 0 != geoCodeStatusCode
	...
	<tml:page id="ThirdPartAction" url="<%=getPage+"ThirdPartAction"%>" type="<%=pageType%>"
		background="<%=imageUrl + "backgroud.png"%>" groupId="<%=GROUP_ID_COMMOM%>">
	</tml:page>
</tml:TML>
