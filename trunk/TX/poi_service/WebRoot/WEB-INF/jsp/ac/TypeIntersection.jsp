...
<tml:TML outputMode="TxNode">
	...
	<tml:script language="fscript" version="1">
		...
		<%@ include file="../Stop.jsp"%>
		    ...
		    func displayButtonImage()
		    	...
		    	string imageUrl = "<%=imageUrl%>"  + "speakInIntersection_" + locale + ".png"
	...
	<tml:menuItem name="autoFill1" onClick="fillBox1" trigger="TRACKBALL_CLICK|KEY_MENU"/>
	<tml:menuItem name="autoFill2" onClick="fillBox2" trigger="TRACKBALL_CLICK|KEY_MENU"/>
	<tml:menuItem name="autoFill3" onClick="fillBox3" trigger="TRACKBALL_CLICK|KEY_MENU"/>
	...
	<tml:page id="typeIntersectionPage" groupId="<%=GROUP_ID_AC%>"
		url="<%=pageUrl%>" type="<%=pageType%>"
		showLeftArrow="true" showRightArrow="true" helpMsg="$//$drivetointersection">
		<tml:title id="title" align="center|middle" fontColor="white"
			fontWeight="bold|system_large">
			<%=msg.get("common.intersection")%>
		</tml:title>
	...
	<% if (!"CN".equals(region)){%>
		<tml:inputBox id="lastLine" fontWeight="system_large"
			isAlwaysShowPrompt="true" prompt="<%=msg.get("ac.tips.lastLine.other")%>"
			type="dropdownfilterfield">
	...
	<% }%>
		...
		<tml:block feature="<%=FeatureConstant.DSR%>">
			<tml:image id="speakInButton" url="<%=imageUrl + "speakInIntersection_en_US.png"%>" />
		</tml:block>
	</tml:page>
