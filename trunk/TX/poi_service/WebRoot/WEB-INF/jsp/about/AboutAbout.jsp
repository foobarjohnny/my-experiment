...
<tml:script language="fscript" version="1">
	...
	<tml:page id="About" url="<%=getPage + "AboutAbout"%>" type="net"   background="<%=imageUrl + "backgroud.png"%>" helpMsg="<%=helpMsg%>">
		<!-- title --> 
		...
		<tml:image id="poweredby" url="<%=imageUrl + "poweredby_in_about.png"%>"/>
