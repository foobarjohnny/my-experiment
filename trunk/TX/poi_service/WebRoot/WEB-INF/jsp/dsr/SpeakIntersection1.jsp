...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="SpeakIntersection" url="<%=getDsrPage + "SpeakIntersection1"%>" type="<%=pageType%>" background="<%=imageUrl + "backgroud_no_title.png"%>" 
		...
		<tml:button id="typeInButton" text="<%=msg.get("dsr.intesection.button.typein")%>"
