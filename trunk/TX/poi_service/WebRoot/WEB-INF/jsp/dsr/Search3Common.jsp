...
<%@page import="com.telenav.cserver.util.FeatureConstant"%>
	...
	<%@ include file="/WEB-INF/jsp/dsr/model/Search3CommonModel.jsp"%>
	...
	<tml:script language="fscript" version="1" feature="<%=FeatureConstant.DSR%>">
        ...
        func preLoad()
        	...
        	showList()
        	Page.setControlProperty("menuListBox","focusedIndex",1)
        ...
        func onShow()
            ...
            System.setKeyEventListener("-1-2-3-4-5-dial-","onKeyPressed")
        endfunc
