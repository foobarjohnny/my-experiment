...
<div id="container_div" class="feedbackBg">
	...
	<div class="feedbackTopDiv">
	  	<!-- feedback question -->
	  	<div id="questionBarDiv" class="clsQuestionBg align_center fc_white">
		  	<div class="clsQuestionContent"><span id="questionContent" class="fs_large"></span></div>
		  	<div class="clsQuestionKey fw_bold" ><span id="questionKey" class="fs_large"></span></div>
	  	</div>
	...
	<div class="gradientLine"></div>
  	...
  	<%-- feedback options --%>
  	<div id="optionListDiv" class="optionsDiv clsFixTable"></div>
	...
	<div class="optionsDiv">
		...
		<div class="div_table clsFeedbackBgBottom clsOptionBgNormal" id="emailDiv">
			<input type="email" class="emailAddress fs_middle fc_gray" id="emailAddress" 
				autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="false"  placeholder='<%=msg.get("poi.feedback.emailContent") %>'/>
		</div>
	</div>
