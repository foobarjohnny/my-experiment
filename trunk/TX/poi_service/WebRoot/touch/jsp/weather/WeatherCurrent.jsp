...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="WeatherCurrent" url="<%=getPage + "WeatherCurrent"%>" type="<%=pageType%>"  helpMsg="$//$weather" groupId="<%=GROUP_ID_MISC%>">
		...
		<!-- new line -->
		<tml:image	id="shadowBg"/>
		<tml:image	id="controlBg"/>
		<tml:button id="weekForecastButton" text="<%=msg.get("weather.weekForecast")%>"
		...
		<tml:button id="changeLocationButton" text="<%=msg.get("common.changeLocation")%>"
			fontWeight="system_large" isFocusable="true" 
			imageClick=""
			imageUnclick="">
