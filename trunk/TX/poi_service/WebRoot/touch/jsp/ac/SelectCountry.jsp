...
<%
    ...
    String checkmarkImage = imageCommonUrl + "checkmark.png";
    String twoLinesImageFocus = imageCommonUrl + "2line_list_highlight.png";
    String twoLinesImageBlur = imageCommonUrl + "2line_list.png";
%>
