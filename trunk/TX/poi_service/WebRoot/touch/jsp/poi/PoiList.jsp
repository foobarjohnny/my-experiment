...
<tml:TML outputMode="TxNode">
		...
		<%@ include file="../GetServerDriven.jsp"%>
			...
			<%}%>
		        ...
		        func showList(int playAudioFlag)
					...
					showSponsorPoi(pageIndex,sortType, canShareAddress)
					...
					while j < endIndex
						...
						if NULL != poiJo
							...
							phone = JSONObject.get(poiJo,"phoneNumber")
						   	...
						   	handleMenuWithLatAndLon(itemId, latAndLon, canShareAddress)
						...
						itemInfo_address_bId = "itemInfo_address_b" + i
						Page.setComponentAttribute(itemInfo_addressId,"text",itemInfo_address)
						Page.setComponentAttribute(itemInfo_address_bId,"text",itemInfo_address)
					    ...
					    if JSONObject.has(poiJo,"menu")
						    ...
						    Page.setComponentAttribute(itemInfo_addressId,"visible","0")
						    Page.setComponentAttribute(itemInfo_address_bId,"visible","1")
						    ...
						    Page.setComponentAttribute(itemInfo_addressId,"visible","1")
						    Page.setComponentAttribute(itemInfo_address_bId,"visible","0")
					    endif
						j = j + 1
						i = i + 1
					endwhile
		        ...
		        func handleMenuWithLatAndLon(String itemId, int latAndLon, int canShareAddress)
					...
					if "sponsorPoi" == itemId
					   MenuItem.setItemValid(itemId,10,canShareAddress)
		            else
		               MenuItem.setItemValid(itemId,12,canShareAddress)
		            endif
		            MenuItem.setItemValid(itemId,4,canShareAddress)
                ...
                func displayBannerAds(JSONObject jo)
                    if jo !=NULL
                        ...
                        if imageUrl!=NULL
                            ...
                            #   String imgData = JSONObject.getString(jo,"imageData")
                           # Page.setControlProperty("bannerAdsImg","imageStringFormData",imgData)
		    ...
		    <%}%>
		        ...
		        func showSponsorPoi(int currentPageIndex,int sortType, int canShareAddress)
		            ...
		            if NULL != sponsorPoiListArray
		               ...
		               if 0 != sponsorPoiListLength
						   ...
						   handleMenuWithLatAndLon("sponsorPoi", latAndLon, canShareAddress)
	...
	<tml:block feature="<%=FeatureConstant.FEEDBACK_POI%>">
		<tml:menuItem name="poiListFeedbackMenu" onClick="poiListFeedback" text="<%=msg.get("common.givefeedback")%>" trigger="KEY_MENU">
		</tml:menuItem>
	...
	<tml:page id="PoiListPage" url="<%=getPage + "PoiList"%>"
		...
		<tml:listBox id="detailPanel">
			...
			<tml:compositeListItem id="sponsorPoi" getFocus="false"
				...
				<tml:label id="itemInfo_distance0" textWrap="ellipsis"
					fontWeight="system" focusFontColor="#FFF000" fontColor="#005AFF"
					align="left">
				</tml:label>
				<tml:label id="itemInfo_address0" textWrap="ellipsis"
					fontWeight="system" focusFontColor="white" align="left">
				</tml:label>

				<tml:label id="itemInfo_sponsor0" textWrap="ellipsis"
					fontWeight="system_small" focusFontColor="#FDF017"
			...
			<tml:compositeListItem id="<%="item" + i%>" getFocus="false"
				...
				<tml:label id="<%="itemInfo_address_b" + i%>" textWrap="ellipsis"
					fontWeight="system" focusFontColor="white" align="left">
				</tml:label>
				...
				<tml:label id="<%="itemInfo_sponsor" + i%>" textWrap="ellipsis"
					visible="false" focusFontColor="#FDF017" fontColor="#005AFF"
					align="left">
				</tml:label>
