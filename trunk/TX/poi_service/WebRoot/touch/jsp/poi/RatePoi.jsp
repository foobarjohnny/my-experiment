...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="RatePoi" url="<%=getPage + "RatePoi"%>" groupId="<%=GROUP_ID_POI%>"
		...
		<tml:menuItem name="ratePoiByTouch" trigger="TRACKBALL_CLICK" onClick="ratePoiByTouch"/>
		<tml:listBox id="list">
			<tml:compositeListItem id="composite"
				...
				<tml:label id="selectRatings" fontWeight="system_large"
					align="center" focusFontColor="black" fontColor="black" textWrap="wrap">
					<%=msg.get("poi.select.ratings")%>
				</tml:label>
				
				<tml:menuRef name="ratePoiByTouch"/>
