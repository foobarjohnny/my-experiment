...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="AddressInfo" url="<%=getPage + "AddressInfo"%>" type="<%=pageType%>"  background="" groupId="<%=GROUP_ID_MISC%>">
		...
		<tml:label id="label" fontWeight="bold|system_median"  align="left"/>
		<tml:nullField id="nullField1"/>
		<tml:label id="street" fontWeight="system_median" align="left"/>	
		<tml:label id="city" fontWeight="system_median"  align="left"/>
		<tml:nullField id="nullField2"/>
		<tml:label id="sentOn" fontWeight="system_median"  align="left"/>
		<tml:nullField id="nullField3"/>
		<tml:label id="nullField4" fontWeight="system_median"  align="left"/>
		<tml:label id="recipients" fontWeight="system_median"  align="left">
			<%=msg.get("addressinfo.recipients")%>
		</tml:label>
		<% for ( int i = 0; i < TnConstants.ADDRESSINFO_MAX_RECIPIENTS; i++ )
		   {
		%>
		<tml:label id="<%="recipient" + i%>" fontWeight="system_median"  align="left"/>
		<% } %>	
		</tml:panel>
