...
<tml:script language="fscript" version="1">
	...
	<%@ include file="/touch62/jsp/ac/AddressAjax.jsp"%>
	<%@ include file="/touch62/jsp/model/OneBoxModel.jsp"%>
	<%@ include file="/touch62/jsp/poi/model/SearchPoiModel.jsp"%>
	<%
	...
	<![CDATA[
	    ...
	    func OneBox_M_searchWithAjax()
	        ...
	        func needChangeSearchPoiTypeForAddress(String from)
	        	int changeFlag = FALSE
	        	if "commute" == from || "movie" == from || "CreateFavorite" == from || "MyFavorite" == from || "DriveTo" == from || "EditRoute" == from
	        		changeFlag = TRUE
	        	endif
	        	return changeFlag
	        endfunc
