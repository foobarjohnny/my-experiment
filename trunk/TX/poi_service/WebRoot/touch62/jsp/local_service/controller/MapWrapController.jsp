...
<tml:script	language="fscript" version="1">
	...
	<![CDATA[
			...
			func MapWrap_C_showMultiAddresses(JSONArray array)
				MapWrap_M_setMapType(<%=MapSerivce.MapType.SINGLE_ADDRESS%>, "multi")
				MapWrap_M_setPoiArray(array, "multi")
				MapWrap_M_setPoiIndex(0, "multi")
				
				MapWrap_M_setShowingMap(0, "multi")
				System.doAction("MapWrap_C_MenuShowMapMulti")
				return FAIL
			endfunc	
			...
			func MapWrap_C_showPoi(JSONArray poiArray, JSONArray sponsorArray, int index, JSONObject stop, int sponsorIndex)
				...
				if 0 != ServerDriven_CanSponsor()
				    ...
				    JSONArray nullsponsorArray
				    MapWrap_M_setSponsorArray(nullsponsorArray,"poi")
				    MapWrap_M_setSponsorIndex(-1,"poi")
				endif
...
<tml:menuItem name="MapWrap_C_MenuShowMapMulti"
	pageURL="<%=getPage+"MapWrap#multi"%>" />
