...
<tml:TML outputMode="TxNode">
	...
	<tml:page id="SpeakSearchAlong1" url="<%=getDsrPage + "SpeakSearchAlong1"%>" type="<%=pageType%>" background=""  
		 genericMenu="4" helpMsg="$//$dsrsearch" groupId="<%=GROUP_ID_DSR%>" supportback="false" >
		<%
			handler.toXML(out);
		%>
