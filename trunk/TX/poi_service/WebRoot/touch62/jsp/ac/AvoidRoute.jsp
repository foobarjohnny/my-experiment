...
<%
    ...
    String product = handlerGloble.getClientInfo(DataHandler.KEY_PRODUCTTYPE);
     if( TnUtil.isBell_VMCUser(strCarrier)||(TnUtil.isUsccAndroid62(handlerGloble)&&!product.toLowerCase().contains("map")))
     {
    	 String [] types1 = { msg.get("ac.avoid.hov"),
			msg.get("ac.avoid.tolls"),
            msg.get("ac.avoid.traffic")};   
    	 types = types1;
     }
     else
     {
    	 String[] types2 = { msg.get("ac.avoid.hov"),
    				msg.get("ac.avoid.tolls") };   
    	 types = types2;
     }
%>
