...
<tml:script language="fscript" version="1">
	...
	func AccountTypeForSprint_IsLiteUser()
        ...
        if <%=Constant.SERVICE_LEVEL_LITE_WITHOUT_FREE_TMO%> == serviceLevel || <%=Constant.SERVICE_LEVEL_LITE_WITH_FREE_TMO%> == serviceLevel || <%=Constant.SERVICE_LEVEL_LITE_WITH_VISUAL_NAV_BAW%> == serviceLevel
	       return TRUE
	    endif
	...
	func AccountTypeForSprint_IsFreeTrial()
	    ...
	    if <%=Constant.SERVICE_LEVEL_FREETRIAL_BAW%> == serviceLevel 
	       return TRUE
	    endif
	...
	func AccountTypeForSprint_IsPremUser()
        ...
        if <%=Constant.SERVICE_LEVEL_PREMIUM_TMO%> == serviceLevel || <%=Constant.SERVICE_LEVEL_PREMIUM_BAW%> == serviceLevel
	       return TRUE
	    endif
