...
<%
	...
	String popupMsgKey = (String)request.getAttribute("popupMsgKey");
	if(!"".equals(popupMsgKey)) {	    
	    popupMessage = msg.get(popupMsgKey);
	}
...
<tml:TML outputMode="TxNode">
	...
	<tml:menuItem name="SyncMenu" pageURL="<%=pageUrl +"&amp;action=sync"%>" trigger="TRACKBALL_CLICK" progressBarText="<%=TnUtil.getXMLString(msg.get("sendaddress.synmessage.title") + " \\\\n " + msg.get("sendaddress.synmessage.body"))%>">
	</tml:menuItem>
