...
<tml:script language="fscript" version="1">
	...
	#Correct Names for TMO by SDY.
	func AccountTypeForTMO_IsLiteUser()
	    int serviceLevel = AccountTypeForTMO_GetServiceLevel()
	    if 0 == serviceLevel
	       return FALSE
	    endif
	...
	func AccountTypeForTMO_IsBundleUser()	    
	    return FALSE
	endfunc
	
	func AccountTypeForTMO_IsFreeTrial()
	    return FALSE
	endfunc
	
	func AccountTypeForTMO_IsPremUser()
	    int serviceLevel = AccountTypeForTMO_GetServiceLevel()
	    if 0 == serviceLevel
	       return FALSE
	    endif
	...
	func AccountTypeForTMO_GetServiceLevel()
	    TxNode serviceLevelNode = UserInfo.getAccountInfo()
        int value = 0
        if NULL != serviceLevelNode && TxNode.getValueSize(serviceLevelNode) > 1
           value = TxNode.valueAt(serviceLevelNode, 1)
