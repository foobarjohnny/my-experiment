...
<%
    ...
    String reviews_imageSolid = imageUrl + "big_solid_star.png";
    String reviews_imageUnSolid = imageUrl + "big_unsolid_star.png";
    String sponsorImage = imageUrl + "big_solid_star.png";
