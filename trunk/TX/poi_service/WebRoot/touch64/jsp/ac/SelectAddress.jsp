...
<% 
	...
	boolean IntersectionFeature = false; // As PM requirement, intersection feature is not required now, once it is required, we can open it according certain condition, 2012-3-19
%>
<tml:TML outputMode="TxNode">
	...
	<tml:script language="fscript" version="1">
        ...
        func onClickGoToOneBox()
        	...
        	String pageUrl = "<%=getPageCallBack + "GoToOneBoxSearch#"%>" + SelectAddress_M_getFrom()
	...
	<tml:page id="SelectAddress" url="<%=pageUrl%>" type="<%=pageType%>" helpMsg="$//$driveto" groupId="<%=GROUP_ID_AC%>" scriptCallback="pageCallBack">
		...
		<%if(IntersectionFeature){%>
			<tml:compositeListItem id="item110" visible="true" bgColor="#FFFFFF"
				isFocusable="true" transparent="false">
				<tml:image id="itemImage110" url="" align="left|top"/>
				<tml:label id="itemlabel110" focusFontColor="white"
					fontWeight="system_large" textWrap="ellipsis"
					align="left|middle">
