...
/**
 * GetTicketQuantityAction.java
 *
 * jhjin@telenav.cn
 * @version 1.0 Dec 21, 2010
 *
 */
public class GetTicketQuantityAction extends HtmlMovieBaseAction
{
    private static Logger logger = Logger.getLogger(GetTicketQuantityAction.class);
    @Override
    protected ActionForward doAction(ActionMapping mapping, HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws Exception
    {
        try
        {
            ...
            ExecutorResponse executorResponse = new GetTicketQuantityResponse();
        ...
        {
            logger.error("GetTicketQuantityAction#doAction",e);
