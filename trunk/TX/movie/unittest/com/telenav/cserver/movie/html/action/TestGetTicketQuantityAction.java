...
//<!------- modify me 1---------
@PrepareForTest({ExecutorDispatcher.class,GetTicketQuantityAction.class,ActionMapping.class})
@SuppressStaticInitializationFor({"com.telenav.cserver.movie.html.action.GetTicketQuantityAction","com.telenav.cserver.framework.executor.ExecutorDispatcher"})
//<!-------
public class TestGetTicketQuantityAction extends TestCase{
	...
	//---- modify me 2----------
	private Class<GetTicketQuantityAction> actionClass = GetTicketQuantityAction.class;
	private GetTicketQuantityAction testedAction = Whitebox.newInstance(actionClass);
	private GetTicketQuantityAction testedAction4Ex = PowerMock.createPartialMock(actionClass,"addErrors");
	private Logger logger = Logger.getLogger(actionClass);
	
	//---- modify me 3 over----------
	private Class<GetTicketQuantityResponse> responseClass = GetTicketQuantityResponse.class;
	private GetTicketQuantityResponse executorResponse = PowerMock.createMock(responseClass);
	//----
