...
//<!------- modify me 1---------
@PrepareForTest({ExecutorDispatcher.class,BookTicketAction.class,ActionMapping.class})
@SuppressStaticInitializationFor({"com.telenav.cserver.movie.html.action.BookTicketAction","com.telenav.cserver.framework.executor.ExecutorDispatcher"})
//<!-------
public class TestBookTicketAction extends TestCase{
	...
	//---- modify me 2----------
	private Class<BookTicketAction> actionClass = BookTicketAction.class;
	private BookTicketAction testedAction = Whitebox.newInstance(actionClass);
	private BookTicketAction testedAction4Ex = PowerMock.createPartialMock(actionClass,"addErrors");
	private Logger logger = Logger.getLogger(actionClass);
	
	//---- modify me 3, over----------
	private Class<BookTicketResponse> responseClass = BookTicketResponse.class;
	private BookTicketResponse executorResponse = PowerMock.createMock(responseClass);
	//----
