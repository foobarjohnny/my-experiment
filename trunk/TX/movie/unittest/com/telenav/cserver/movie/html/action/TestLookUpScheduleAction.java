...
//<!------- modify me 1---------
@PrepareForTest({ExecutorDispatcher.class,LookUpScheduleAction.class,ActionMapping.class})
@SuppressStaticInitializationFor({"com.telenav.cserver.movie.html.action.LookUpScheduleAction","com.telenav.cserver.framework.executor.ExecutorDispatcher"})
//<!-------
public class TestLookUpScheduleAction extends TestCase{
	...
	//---- modify me 2----------
	private Class<LookUpScheduleAction> actionClass = LookUpScheduleAction.class;
	private LookUpScheduleAction testedAction = Whitebox.newInstance(actionClass);
	private LookUpScheduleAction testedAction4Ex = PowerMock.createPartialMock(actionClass,"addErrors");
	
	//---- modify me 3, over----------
	private Class<LookUpScheduleResponse> responseClass = LookUpScheduleResponse.class;
	private LookUpScheduleResponse executorResponse = PowerMock.createMock(responseClass);
	//----
