...
import com.telenav.datatypes.content.cose.v20.PoiDataSet;
import com.telenav.datatypes.content.cose.v20.PoiSearchArea;
import com.telenav.datatypes.content.cose.v20.PoiSearchAreaType;
import com.telenav.datatypes.content.cose.v20.PoiSearchService;
import com.telenav.datatypes.content.cose.v20.PoiSearchType;
import com.telenav.datatypes.content.cose.v20.ServiceAgent;
import com.telenav.datatypes.content.cose.v20.ServiceVendor;
import com.telenav.kernel.util.datatypes.TnContext;
import com.telenav.services.content.v20.ContentInfoService20Stub;
import com.telenav.services.content.v20.ContentSearchServiceStub;
 ...
 */
public class PoiSearchProxyV20
{
    private static final Logger logger = Logger.getLogger(PoiSearchProxyV20.class);

    public static final String POI_SEARCH_SERVICE = "POI_SEARCH20";
    ...
    public PoiSearchProxyV20(TnContext tc)
    {
        tnContext = tc;
    }
    ...
    private PoiSearchResponse searchAirport(AirportSearchRequest req, PoiSearchAreaType psaType) throws ThrottlingException
    {
        ...
        com.telenav.services.content.v20.PoiRequest request = PoiSearchConverterV20.airportRequesttoWSRequest(req);
        if (tnContext != null)
        {
        ...
        com.telenav.services.content.v20.PoiSearchResponse response = search(request, req.getRegion());
        if(response != null)
        {
            poiSearchResponse = PoiSearchConverterV20.convertWSRespToPoiSearchResponse(response);
    ...
    {   
        ...
        PoiSearchResponse poiSearchResponse = new PoiSearchResponse();
        com.telenav.services.content.v20.PoiRequest request = PoiSearchConverterV20.poiRequesttoWSRequest(req);
        if(request == null)
        {
            if(logger.isDebugEnabled())
            {
    ...
    public PoiDetailsResponse getPoiDetails(PoiDetailsRequest request)  throws ThrottlingException
    {
    	...
    	com.telenav.services.content.v20.GetPoiDetailsRequest req = PoiSearchConverterV20.createPoiDetailsRequest(request);
    	if(tnContext != null)
    	{
    	...
    	com.telenav.services.content.v20.GetPoiDetailsResponse resp = getPoiDetails(req);
    	if(resp != null)
    	{
    		response = PoiSearchConverterV20.createPoiDetailsResponse(resp);
    		if(logger.isDebugEnabled())
    		{
    ...
    private static ConfigurationContext getConfigContext(WebServiceItem serviceItem) throws AxisFault
    {
        ...
        {
            synchronized (PoiSearchProxyV20.class)
            {
    ...
    private void setRequestInfo(com.telenav.services.content.v20.PoiRequest request)
    {
    ...
    private com.telenav.services.content.v20.GetPoiDetailsResponse getPoiDetails(com.telenav.services.content.v20.GetPoiDetailsRequest request) throws ThrottlingException
    {
    	...
    	com.telenav.services.content.v20.GetPoiDetailsResponse response = null;
    	...
    	try
    	{
    		...
    		try
    		{
    			...
    			if(endpoint != null)
    			{
    				stub = new ContentInfoService20Stub(getConfigContext(wsConfig.getWebServiceItem()), endpoint);
    ...
    private com.telenav.services.content.v20.PoiSearchResponse search(com.telenav.services.content.v20.PoiRequest request, String region) throws ThrottlingException
    {  
    	CliTransaction cli = new CliTransaction(CliConstants.TYPE_MODULE);
		cli.setFunctionName("Poi_Search");
        ContentSearchServiceStub stub = null;
        com.telenav.services.content.v20.PoiSearchResponse response = null;
        boolean startAPICall = false;
        try
        {
            startAPICall = ThrottlingManager.startAPICall(SERVICE_POISEARCHSERVER, this.tnContext);
     ...
     * @return
     */
    private String cliPoiSearchResponse(com.telenav.services.content.v20.PoiSearchResponse response) {
     ...
     * @return
     */
    private String cliPoiSearchRequest(com.telenav.services.content.v20.PoiRequest request) {
	    StringBuilder sb=new StringBuilder();
	    sb.append("request==>[");
    ...
    private String getEndpoint(Map<?,?> urlMap, com.telenav.services.content.v20.PoiRequest request, String region)
    {
