...
import com.telenav.services.favorite.v10.FavoriteServiceStub;
...
public class FavoritesServiceProxy
{
    ...
    private final static String WS_FAVORITES = "FAVORITE";
    ...
    public FavoriteConfirmResponse confirmReceived(FavoriteConfirmRequest cRequest, TnContext tc) throws ThrottlingException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                ServiceMgmtResponseDTO response = stub.confirmedReceived(request);
