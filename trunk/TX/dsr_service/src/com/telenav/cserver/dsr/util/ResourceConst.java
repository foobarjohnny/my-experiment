...
public class ResourceConst
{
    ...
    //for node with recType: TYPE_KEY_VALUE_MAPPING
...
//    public final static int DSR_RECOGNIZE_POI = 501;
    public final static int DSR_RECOGNIZE_CITY_STATE_GEOCODING = -1;
    public final static int DSR_RECOGNIZE_CITY_STATE = 0;
    public final static int DSR_RECOGNIZE_POI = 1;
    ...
    public final static int DSR_RECOGNIZE_EMAIL_COMMAND = 7;
    ...
    public final static int DSR_RECOGNIZE_ONE_SHOT_POI = 11;
    public final static int DSR_RECOGNIZE_TICKET = 12;
    
    public final static int DSR_TTS_MY_STUFF = 11;
    public final static int DSR_TTS_FAVORITE = 12;

    public final static int DSR_RECOGNIZE_INTERSECTION = 403;
    public final static int TEXT_TO_SPEECH = 901;

    public static final String DSR_COMMAND_DRIVE = "drive";
    public static final String DSR_COMMAND_SEARCH = "search";
    public static final String DSR_COMMAND_MAP = "map";
    public static final String DSR_COMMAND_RESUME = "resume";
    public static final String DSR_COMMAND_SHOW = "show";
    
    
    public static final String DSR_TARGET_WEATHER = "weather";
    public static final String DSR_TARGET_MOVIES = "movie";
    public static final String DSR_TARGET_TRAFFIC = "traffic";
    public static final String DSR_TARGET_COMMUTE = "commute";
    public static final String DSR_TARGET_HOME = "home";
    public static final String DSR_TARGET_WORK = "work";
    ...
    public static final String FLAG_SLOT = "flag" ;
    public static final String LITERAL_SLOT = "literal" ;
    
    public static final String TRANSACTION_ID = "transaction_id" ;
    
    // AUDIO FORMATS
    public final static int FMT_AMR = 0;
    public final static int FMT_GSM = 1;
    public final static int FMT_3GPP_AMR = 2;
    public final static int FMT_SPEEX = 3;
    public final static int FMT_QCP = 4;
    public final static int FMT_PCM = 10;  // FOR VLINGO
    
    // PROCESSED RESULT OBJECT TYPES
    public final static int RES_OBJ_STOP = 0 ;
    public final static int RES_OBJ_AUDIO_PROMPT = 1 ;
    public final static int RES_OBJ_AUDIO_MSG = 2 ;
    
    
    // STATUS CODES
    public final static int SERVER_ERROR = 500 ;
    public final static int SERVER_SUCCESS = 200 ;
    public final static int VERSION_NOT_SUPPORTED = 505 ;
